namespace Repository.Pattern.Ef6.Factories
{
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private readonly IDictionary<Type, Func<IDataContextAsync, IUnitOfWorkAsync, dynamic>> repositoryFactories;
        ...
        {
            this.repositoryFactories = this.GetFactories();
            this.CustomRepositoryFactories = new Dictionary<Type, Func<dynamic>>();
        }

        public RepositoryFactories(Dictionary<Type, Func<dynamic>> customRepositoryFactories)
        {
            this.repositoryFactories = this.GetFactories();
            this.CustomRepositoryFactories = customRepositoryFactories;
        }
