// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DesignOfMatrixPropertyValue.cs" company="Emergence-I">
...
namespace eLimsWebSeries.ResourceServer.Entity.Entities.DesignEntities
{
    ...
    public sealed class DesignOfMatrixPropertyValue : EntityBase
    {
        ...
        public DesignOfMatrixPropertyChoice MatrixPropertyChoice { get; set; }
