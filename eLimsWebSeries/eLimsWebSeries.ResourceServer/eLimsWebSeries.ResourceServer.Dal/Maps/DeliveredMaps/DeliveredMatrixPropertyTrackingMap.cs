// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DeliveredMatrixPropertyTrackingMap.cs" company="Emergence-I">
...
namespace eLimsWebSeries.ResourceServer.Dal.Maps.DeliveredMaps
{
    ...
    public sealed class DeliveredMatrixPropertyTrackingMap : EntityTypeConfiguration<DeliveredMatrixPropertyTracking>
    {
        public DeliveredMatrixPropertyTrackingMap()
        {
            // table name
